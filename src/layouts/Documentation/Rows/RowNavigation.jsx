    ...
    return (
      <div id="navbar-row" className="tim-row">
        ...
        <p>
          ...
          find it in <code>src/components/Sidebar/Sidebar.jsx</code>. This is
          ...
          <code>src/routes/dashboard.jsx</code>. We import them in this
        ...
        <p>
          ...
          <code>src/layouts/Dashboard/Dashboard.jsx</code>. Here you will find
        ...
        <p>
          ...
          <code>src/components/Header/HeaderLinks.jsx</code>.
        </p>
        <p>
